...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "vCQveddo*****AuRU7Aq",
    "consumer_secret"     :  "d15upoc******aE0t8yOZ5b5Hr1cjhtbVQTK",
    "access_token"        :  "228715898****KsZEBU*****tBdKTydGMDqHR5",
    "access_token_secret" :  "fwVCAU4qC********Vvoqn9LtI0XpvfZ",
}
